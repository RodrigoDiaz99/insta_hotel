...
@section('content')
    ...
    <div class="container-fluid">
        <header class="card px-2 py-4">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="h2">Almacen de {{$establishment->name}}</h3>
                                        ...
                                        <table class="table align-items-center mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($almacen as $row)
                                                    <tr>
                                                        <td>
                                                            <h6 class="text-sm">{{ $row->product->name }}</h6>
                                                        </td>

                                                        <td  >
                                                            <h6 class="text-sm">{{ $row->quantity }}</h6>
                                                        </td>
 ...
 --}}
    ...
    @include('almacen.extras.modals.createIngredient')
    @include('almacen.extras.modals.editIngredient')
@endsection
