<div class="container-fluid">
    <header class="card px-2 py-4 mb-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <button type="button" class="btn btn-icon btn-success d-flex align-items-center" data-toggle="modal"
                data-target="#addEstablishmentAreas">
    ...
    @section('livewire-js')
        <script>
            Livewire.on('updateEstablishmentArea', postId => {
                $('#editEstablishmentAreas').modal('show');
            })
            ...
            Livewire.on('establishmentAreaUpdated', postId => {
                Swal.fire(
                    'Área Actualizada',
