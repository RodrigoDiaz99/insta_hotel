<div class="container-fluid">
    <header class="card px-2 py-4 mb-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('establishments.rooms.create', $establishment) }}"
                ...
                <span class="btn-inner--text">Agregar Habitación</span>
            </a>
        </div>
    </header>
    ...
    <div class="card px-2 py-4">
        <div class="mb-4">
            ...
            <div wire:loading.remove wire:target='search' class="row gx-2 gy-4">
                @forelse ($establishment->rooms as $row)
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header p-0 mx-3 mt-3">
                                <img src="https://hotelcasadelrefugio.com/wp-content/uploads/2018/02/icon-cama.png"
                            ...
                            <div class="card-body pt-2">
                                ...
                                <span class="text-xs font-weight-bold my-2">
                                    <strong>Capcidad: </strong><span>{{ $row->room_capacity }} Personas</span>
                                </span>
                                ...
                                <section class="row">
                                    <div class="col">
                                        <button class="btn btn-block btn-warning" data-toggle="modal"
                                            ...
                                            wire:click='$emit("editRoom", {{ $row->id }})'>
                                    ...
                                    {{-- <div class="col">
                                        <a href="{{ route('establishments.rooms.shellies.index') }}" class="btn btn-block btn-primary">
                                            Shellies
                                        </button>
                                    </div> --}}
                        ...
                        <svg height="179" viewBox="0 0 315 179" width="315" xmlns="http://www.w3.org/2000/svg">
                            <g fill="none" fill-rule="evenodd">
                                ...
                                <g transform="translate(25)">
                                    <rect fill="#fff" height="175" rx="10" stroke="#eee" stroke-width="4" width="274"
                                        x="2" y="2" />
                                    ...
                                    <rect fill="#6b4fbb" height="4" opacity=".5" rx="2" width="15" x="196" y="114" />
