    ...
    <div class="container-fluid">
        <header class="card px-2 py-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="h2">Familia de Productos</h3>
                                            ...
                                            <tbody>
                                                @foreach ($type as $row)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="text-sm">{{ $row->description ? $row->description : 'Sin descripción' }}</h6>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    @include('types.extras.modals.editProductType')
                                                                </div>
                                                                <div class="col-md-6">
