...
@section('content')
    ...
    <div class="container-fluid">
        <header class="card px-2 py-4">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="h2">Proveedores</h3>

                <a href="#" class="btn btn-icon btn-success d-flex align-items-center" data-toggle="modal" data-target="#addProveedor">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="h5">Administra los proveedores.</h3>
            </div>
        </header>
                                            ...
                                            <tbody>
                                                @foreach ($proveedores as $row)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="text-sm">{{ $row->direccion }}</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="text-sm">{{ $row->numero }}</h6>
                                                        </td>

                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <a title="Editar Proveedor" type="button" class="btn btn-icon btn-success" data-toggle="modal" data-target="#editProveedor-{{$row->id}}">
                                                                        <i class="fas fa-edit"></i>
                                                                    </a>
                                                                </div>
                                                                @include('proveedores.extras.modals.editProveedor')
                                                                <div class="col-md-6">
                                                                    <form action="{{ route('proveedores.delete', $row->id) }}" method="post">
                                                                        @csrf
                                                                        @method('DELETE')
    ...
    @include('proveedores.extras.modals.createProveedores')
